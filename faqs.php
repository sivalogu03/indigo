<?php
$page_title = "Frequently Asked Questions | Indigo Interiors Bangalore";
...
<div class="container py-5 text-center">
    <h3 class="mb-4">Still have questions? We're here to help!</h3>
    <a href="contact-us.php" class="btn-default">Contact Our Experts</a>
</div>
